...
<body class="container mt-5">
  ...
  <form action="${pageContext.request.contextPath}/ClienteServlet?action=create" method="post">
  <div class="my-3">
      <label for="cedula" class="form-label">Cedula del Cliente</label>
      <input type="text" class="form-control" name="cedula" id="cedula" maxlength="20" required>
    </div>
    <div class="my-3">
    ...
    <div class="my-3">
      <label for="telefono" class="form-label">Numero telefonico</label>
       <input type="text" class="form-control" name="telefono" id="telefono" maxlength="30" required>
    </div>
    <div class="my-3">
      <label for="correo" class="form-label">Correo electronico</label>
       <input type="text" class="form-control" name="correo" id="correo" maxlength="80" required>
    </div>
