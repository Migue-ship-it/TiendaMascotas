...
<body>
	...
	<form action="ClienteServlet" method="get">
		<div class="container">
			...
			<label for="apellidos">apellidos</label> <input type="text" name="apellidos" id="apellidos" maxlength="50"><br><br />
			<label for="direccion">direccion</label> <input type="text",name="direccion" id="direccion" maxlength="50"><br><br />
