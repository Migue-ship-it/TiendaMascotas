...
<body class="container mt-5">
  ...
  <form action="MascotaServlet" method="get">
    ...
    <div class="my-3">
      ...
      <input type="text" class="form-control" name="genero" id="genero" maxlength="30">
    </div>
    <div class="my-3">
      <label for="raza" class="form-label">Raza</label>
      <input type="text" class="form-control" name="raza" id="raza" maxlength="50">
    </div>
    <div class="my-3">
      <label for="codigo" class="form-label">Código perteneciente</label>
      <input type="number" class="form-control" name="codigo" id="codigo" maxlength="10">
    </div>
     <a href="listaMascotas.jsp">Listado de mascotas</a>
